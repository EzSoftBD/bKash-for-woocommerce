...
bKash Payment Gateway provides range of payment solutions to merchants of the online sphere. By installing this plugin you’ll be able to integrate the bKash PGW, into your WooCommerce Webshop. The bKash PGW plugin extends WooCommerce allowing you to take payments directly on your store via bKash’s API. This will only take a few minutes. If the plugin is successfully installed your customers will then be able to checkout with bKash payment gateway.
Maintained by: Tahmidul Haque (EzSoft) | Support: support@ezsoftbd.com | Website: https://ezsoftbd.com
